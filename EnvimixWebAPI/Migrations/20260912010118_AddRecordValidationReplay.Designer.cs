...
namespace EnvimixWebAPI.Migrations
{
    ...
    [Migration("20260912010118_AddRecordValidationReplay")]
    partial class AddRecordValidationReplay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.CampaignEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.MapDataEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.RecordEntity", b =>
                {
                    ...
                    b.Property<ulong?>("RemovedMessageDiscordSnowflake")
                    ...
                    b.Property<Guid?>("ValidationReplayId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.ReplayEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.ServerEntity", b =>
                {
                    ...
                    b.Property<string>("ControllerCodeHash")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");

                    b.Property<string>("ControllerCodeSalt")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.EnvimaniaSessionEntity", b =>
                {
                    ...
                    b.HasOne("EnvimixWebAPI.Entities.TitleEntity", "Title")
                        .WithMany()
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.MapEntity", b =>
                {
                    b.HasOne("EnvimixWebAPI.Entities.CampaignEntity", "Campaign")
                        .WithMany()
                        .HasForeignKey("CampaignId");

                    b.HasOne("EnvimixWebAPI.Entities.MapDataEntity", "Data")
                        .WithMany()
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.RecordEntity", b =>
                {
                    ...
                    b.HasOne("EnvimixWebAPI.Entities.ReplayEntity", "Replay")
                        .WithMany()
                    ...
                    b.HasOne("EnvimixWebAPI.Entities.ReplayEntity", "ValidationReplay")
                        .WithMany()
                        .HasForeignKey("ValidationReplayId");
            ...
            modelBuilder.Entity("EnvimixWebAPI.Entities.UserEntity", b =>
                {
                    ...
                    b.Navigation("RegisteredServers");
                });
